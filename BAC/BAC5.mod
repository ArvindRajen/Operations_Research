...
subject to BAC0: sum{i in CITIES}fp[i]=4;

subject to BAC1: fp[24] + fp[25] = 1;

subject to BAC2: fp[22] + fp[25] = 1;

subject to BAC3: fp[20] + fp[25] = 1;

subject to BAC4: fp[9] + fp[13] = 1;

subject to BAC5: fp[5] + fp[7] = 1;
