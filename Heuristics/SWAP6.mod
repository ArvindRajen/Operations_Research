...
subject to SWAP6: fw[11,1] + sum{i in 24..25}fw[i,1]=2;

subject to QUARTER{q in 2..4}: sum{i in 23..25}fw[i,q]=3;

subject to QUARTEROFF{q in 2..4}:sum{i in 1..22} fw[i,q]=0;
